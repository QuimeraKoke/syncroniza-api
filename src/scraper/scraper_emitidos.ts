...
async function scrapeDocumentsIssued(project: IProject) {
    ...
    try {
        ...
        await page.waitForTimeout(1000);
        await page.locator('xpath=//*[@id="collapseTwo"]/div/ul/li[1]/a').click();
                ...
                for (let i = 0; i < rowCount; i++) {
                    ...
                    let oversea = false;
                        ...
                        if (data[3] === 'Factura Electronica'){
                            data[3] = 'FACTURA'
                            data[4] = 'E-'+'F-'+data[1]+'-'+data[4]
                        } else if (data[3] === 'Factura Exenta Electronica'){
                            data[3] = 'FACTURA'
                            data[4] = 'E-'+'FX-'+data[1]+'-'+data[4]
                        } else if (data[3] === 'Factura de Compra Electronica'){
                            data[3] = 'FACTURA'
                            data[4] = 'E-'+'FC-'+data[1]+'-'+data[4]
                        } else if (data[3] === 'Nota de Debito Electronica'){
                            data[3] = 'NNDD'
                            data[4] = 'E-'+'ND-'+data[1]+'-'+data[4]
                        } else if (data[3] === 'Nota de Credito Electronica'){
                            data[3] = 'NNCC'
                            data[4] = 'E-'+'NC-'+data[1]+'-'+data[4]
                        } else if (data[3] === 'Guia de Despacho Electronica'){
                            data[3] = 'GGDD'
                            data[4] = 'E-'+'GD-'+data[1]+'-'+data[4]
                        } else if (data[3] === 'Factura de Exportacion Electronica'){
                            data[3] = 'FACTURA'
                            data[4] = 'E-'+'FEX-'+data[1]+'-'+data[4]
                            oversea = true;
                        } else if (data[3] === 'Nota de Debito de Exportacion Electronica'){
                            data[3] = 'NNDD'
                            data[4] = 'E-'+'NDEX-'+data[1]+'-'+data[4]
                            oversea = true;
                        } else if (data[3] === 'Nota de Credito de Exportacion Electronica'){
                            data[3] = 'NNCC'
                            data[4] = 'E-'+'NCEX-'+data[1]+'-'+data[4]
                            oversea = true;
                        }
